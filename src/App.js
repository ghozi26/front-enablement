...
import KPIStatus from "./pages/KPIStatus";
    ...
    <div className={classes.root}>
      ...
      >
        <Toolbar className={classes.toolbar}>
          ...
          <Typography component="h6" variant="h6" color="inherit" noWrap className={classes.title} style={{textAlign:'right', marginLeft:'auto', marginRight:'30px'}}>
            Indicative Financial KPI Achievment : <span style={{color:'#009688'}}>70%</span>
          </Typography>
          <Divider orientation={'vertical'} flexItem />
          <Typography component="h6" variant="h6" color="inherit" noWrap className={classes.title} style={{textAlign:'right', marginLeft:'30px', marginRight:'30px'}}>
